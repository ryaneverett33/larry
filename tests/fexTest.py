...
def main():
    ...
    pic.applyNewConfig(None, "128.210.148.000/24 Public Subnet (1)", "100/1000T-SW-A")
    ticket.addPic(pic)
    ...
    pic.applyCurrentConfig(None, "128.210.148.000/24 Public Subnet (1)", "10/100/1000T-SW-A")
