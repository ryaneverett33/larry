...
class PICTests(unittest.TestCase):
    def test_PIC(self):
        pic = PIC('GCMB-103-B', 'gcmb-100-c3560cg-01-Gi0/6', 'gcmb-100-c3560cg-01-Gi0/6', 'Activate', None)
        ...
        pic2 = PIC('MJIS-1063HW-UPS', 'mjis-1063-c9348uxm-01:01-Te1/0/48', 'mjis-1063-c9348uxm-01:01-Te1/0/48', 'Modify', None)
